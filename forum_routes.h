...
private:
    ...
    // GET /forum/posts/id
    static QHttpServerResponse getPost(const QHttpServerRequest &request, const QString &id);

    // POST /forum/posts
    static QHttpServerResponse createPost(const QHttpServerRequest &request);

    // GET /forum/posts/id/comments
    static QHttpServerResponse getPostComments(const QHttpServerRequest &request, const QString &id);

    // POST /forum/posts/id/comments
    static QHttpServerResponse createComment(const QHttpServerRequest &request, const QString &id);

    // GET /forum/categories
    static QHttpServerResponse getCategories(const QHttpServerRequest &request);

    // POST /forum/posts/id/vote
    static QHttpServerResponse votePost(const QHttpServerRequest &request, const QString &id);
